...
<style>
    ...
    #contentBox {width: 800px; margin-left: 230px;}
			...
			<form id="fregister" action="/register">
				...
				<section id="fregister_term">
					...
					<textarea readonly>제1조(목적) 이 약관은 &#034;시크릿 포레스트&#034; 회사(전자상거래 사업자)가 운영하는 &#034;시크릿 포레스트&#034; 사이버 몰(이하 “몰”이라 한다)에서 제공하는 인터넷 관련 서비스(이하 “서비스”라 한다)를 이용함에 있어 사이버 몰과 이용자의 권리ㆍ의무 및 책임사항을 규정함을 목적으로 합니다.
						...
						① “몰”이란 &#034;시크릿 포레스트&#034; 회사가 재화 또는 용역(이하 “재화등”이라 함)을 이용자에게 제공하기 위하여 컴퓨터등 정보통신설비를 이용하여 재화등을 거래할 수 있도록 설정한 가상의 영업장을 말하며, 아울러 사이버몰을 운영하는 사업자의 의미로도 사용합니다.
						...
						① “몰”은 이 약관의 내용과 상호 및 대표자 성명, 영업소 소재지 주소(소비자의 불만을 처리할 수 있는 곳의 주소를 포함), 전화번호ㆍ모사전송번호ㆍ전자우편주소, 사업자등록번호, 통신판매업신고번호, 개인정보관리책임자등을 이용자가 쉽게 알 수 있도록 &#034;시크릿 포레스트&#034; 사이버몰의 초기 서비스화면(전면)에 게시합니다. 다만, 약관의 내용은 이용자가 연결화면을 통하여 볼 수 있도록 할 수 있습니다.
						...
						① “몰”의 서비스 제공은 회사나 IDC의 장애사유가 발생하거나, 장비의 보수점검, 교체 및 통신 두절 및 우편서비스의 비정상적 처리 또는 기타 회사 자체의 사정으로 일시적 혹은 단속적으로 중단될 수 있습니다.
						...
						① “몰”과 재화등의 구매에 관한 계약을 체결한 이용자는 수신확인의 통지를 받은 날부터 당일 이내에는 청약의 철회를 할 수 있습니다.
						...
						② 이용자는 재화등을 배송받은 경우 다음 각호의 1에 해당하는 경우에는 반품 및 교환을 할 수 없습니다.
								...
								5. 이용자의 구매의사 변화의 경우(단, 상품배송 전일일 경우)
								6. 상품제작이 완료된 후 고객 변심에 의한 상품 교환 및 취소는 불가함.
								7. 회원님 사정으로 인한 취소 및 환불시 수수료가 부과 될 수 있습니다.
								8. 받으시는분의 수신 거부시에는 환불 불가함.
						
						
						③ 제2항제2호 내지 제4호의 경우에 “몰”이 사전에 청약철회 등이 제한되는 사실을 소비자가 쉽게 알 수 있는 곳에 명기하거나 시용상품을 제공하는 등의 조치를 하지 않았다면 이용자의 청약철회등이 제한되지 않습니다.
						
						④ 이용자는 제1항 및 제2항의 규정에 불구하고 재화등의 내용이 표시·광고 내용과 다르거나 계약내용과 다르게 이행된 때에는 당해 재화등을 공급받은 날부터 3일이내, 그 사실을 안 날 또는 알 수 있었던 날부터 7일 이내에 청약철회 등을 할 수 있습니다.
						...
						① “몰”은 이용자가 제기하는 정당한 의견이나 불만을 반영하고 그 피해를 보상처리하기 위하여 피해보상처리기구를 직접 설치ㆍ운영합니다.
