...
<body>
 <%@ include file ="../header.jsp" %>
  <div id="page">
     ...
     <div id="contentBox">
				<fieldset>
					<h2 style="font-size: 24px; color: #2b2a29;">회원 가입</h2>
					<p style="font-size: 14px; color: #81817f;"><img src="resources/image/etc/check.png">&nbsp;join us</p>
					<div>
						<table>
							<th>
								<p>사이트 이용정보 입력</p>
						...
						<ul>
								...
								<li>
									<span class="opt_chk">
										...
										<span class="frm_info">
												정보공개를 바꾸시면 앞으로 30일 이내에는 변경이 안됩니다.
										</span>                
								</li>
						</ul>
						</div>
					</div>
					<button id="account" class="chkBtn" type="submit">회원 등록</button>
				</fieldset>
		</div>
		<script>
